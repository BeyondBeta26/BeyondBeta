...
function wireSubscribeModal(){
  ...
  /* Direct signup links: any page URL ending in #subscribe opens the
     popup immediately on load (instead of only scrolling to the footer
     form), so a link like beyondbeta.eu/#subscribe can be shared as a
     one-click signup. Works on every page, since each has its own
     wired-up modal. */
